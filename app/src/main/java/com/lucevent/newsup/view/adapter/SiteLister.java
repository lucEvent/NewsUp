...
public class SiteLister extends ArrayAdapter<Site> {
    ...
    private Sites sites;
    private NewsManager dataCenter;

    private LayoutInflater inflater;

    public SiteLister(Context context, NewsManager dataCenter, boolean showMenu) {
        super(context, -1, new Sites((String[]) null));
 ...
 */   }
    ...
    public SiteLister(Context context, Sites values) {
 ...
 */       return views[position];
 ...
 /*   private View getMenuView(ViewGroup parent) {
        ...
        Sites favs = dataCenter.getFavoritesSites();
        if (!favs.isEmpty()) {
            for (Site fav : favs) {
