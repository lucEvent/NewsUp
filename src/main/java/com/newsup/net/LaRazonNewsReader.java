...
public class LaRazonNewsReader extends NewsReader {
    ...
    public LaRazonNewsReader() {
        ...
        SECTIONS.add(new Section("Últimas noticias", 0, "http://www.larazon.es/rss/portada.xml"));
        ...
        SECTIONS.add(new Section("Fútbol", 1, "http://www.larazon.es/rss/deportes/futbol.xml"));
        ...
        SECTIONS.add(new Section("Formula 1", 1, "http://www.larazon.es/rss/deportes/formula1.xml"));
        ...
        SECTIONS.add(new Section("Religión", 0, "http://www.larazon.es/rss/religion.xml"));
        ...
        SECTIONS.add(new Section("Gastronomía", 1, "http://www.larazon.es/rss/cultura/gastronomia.xml"));
