...
public class TheLocalNewsReader extends NewsReader {
    ...
    public TheLocalNewsReader(Handler handler, Context context) {
        ...
        SECTIONS.add(new Section("Recent", 1, "http://shop.thelocal.se/rss.php?action=newblogs&type=rss"));
        SECTIONS.add(new Section("New", 1, "http://shop.thelocal.se/rss.php?type=rss"));
        SECTIONS.add(new Section("Popular", 1, "http://shop.thelocal.se/rss.php?action=popularproducts&type=rss"));
        SECTIONS.add(new Section("Featured", 1, "http://shop.thelocal.se/rss.php?action=featuredproducts&type=rss"));
