...
//        add(new Site(425, "Ilta Sanomat", 0xff, new com.lucevent.newsup.data.section.IltaSanomatSections(), new com.lucevent.newsup.data.reader.IltaSanomat()));
*/
        // British sites
...
//        add(new Site(705, "The Huffington Post (Arabic)", 0xff2c705f, new com.lucevent.newsup.data.section.HuffingtonPostArabicSections(), new com.lucevent.newsup.data.reader.HuffingtonPostArabic()));
