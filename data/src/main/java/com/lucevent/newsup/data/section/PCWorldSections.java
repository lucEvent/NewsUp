...
public class PCWorldSections extends Sections {
    ...
    public PCWorldSections()
    {
        ...
        add(new Section("Laptop accessories", "http://www.pcworld.com/category/laptop-accessories/index.rss", 1));
        ...
        add(new Section("Phone accessories", "http://www.pcworld.com/category/phone-accessories/index.rss", 1));
