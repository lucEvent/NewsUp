...
public class HuffingtonPostUSASections extends com.lucevent.newsup.data.util.Sections {
    ...
    public HuffingtonPostUSASections() {
        ...
        add(new Section("Business", "http://www.huffingtonpost.com/feeds/verticals/business/index.xml", 0));
        add(new Section("Celebrity", "http://www.huffingtonpost.com/feeds/verticals/celebrity/index.xml", 0));
        add(new Section("College", "http://www.huffingtonpost.com/feeds/verticals/college/index.xml", 0));
        add(new Section("Comedy", "http://www.huffingtonpost.com/feeds/verticals/comedy/index.xml", 0));
        add(new Section("Crime", "http://www.huffingtonpost.com/feeds/verticals/crime/index.xml", 0));
        add(new Section("Education", "http://www.huffingtonpost.com/feeds/verticals/education/index.xml", 0));
        ...
        add(new Section("Politics", "http://www.huffingtonpost.com/feeds/verticals/politics/index.xml", 0));
        add(new Section("Religion", "http://www.huffingtonpost.com/feeds/verticals/religion/index.xml", 0));
        add(new Section("Science", "http://www.huffingtonpost.com/feeds/verticals/science/index.xml", 0));
        ...
        add(new Section("Teen", "http://www.huffingtonpost.com/feeds/verticals/teen/index.xml", 0));
        add(new Section("Travel", "http://www.huffingtonpost.com/feeds/verticals/travel/index.xml", 0));
        add(new Section("Weird News", "http://www.huffingtonpost.com/feeds/verticals/weird-news/index.xml", 0));
        add(new Section("Women", "http://www.huffingtonpost.com/feeds/verticals/women/index.xml", 0));
        add(new Section("World Post", "http://www.huffingtonpost.com/feeds/verticals/world/index.xml", 0));
