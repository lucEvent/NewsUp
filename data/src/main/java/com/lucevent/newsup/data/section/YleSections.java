...
public class YleSections extends Sections {
    ...
    public YleSections()
    {
        ...
        add(new Section("Luetuimmat uutiset", "http://yle.fi/urheilu/rss/luetuimmat.rss", 1));
        ...
        add(new Section("Ampuminen", "http://yle.fi/urheilu/rss/uutiset.rss?osasto=ampuminen", 1));
        ...
        add(new Section("Muu palloilu", "http://yle.fi/urheilu/rss/uutiset.rss?osasto=muu_palloilu", 1));
        add(new Section("Muu urheilu", "http://yle.fi/urheilu/rss/uutiset.rss?osasto=muut", 1));
