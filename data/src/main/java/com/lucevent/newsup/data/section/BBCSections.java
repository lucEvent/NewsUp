...
public class BBCSections extends Sections {
    ...
    public BBCSections() {
        ...
        add(new Section("Top stories", "http://feeds.bbci.co.uk/news/video_and_audio/news_front_page/rss.xml?edition=uk", 1));
        ...
        add(new Section("Latest published stories", "http://feeds.bbci.co.uk/news/system/latest_published_content/rss.xml", 1));
        ...
        add(new Section("Special Reports", "http://feeds.bbci.co.uk/news/special_reports/rss.xml", 1));
