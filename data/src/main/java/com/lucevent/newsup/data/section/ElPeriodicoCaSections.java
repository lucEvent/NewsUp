...
public class ElPeriodicoCaSections extends Sections {
    ...
    public ElPeriodicoCaSections()
    {
        ...
        add(new Section("Motor", "http://www.elperiodico.cat/ca/rss/motor/rss.xml", 0));
        ...
        add(new Section("Your disco needs you", "http://blogs.timeout.cat/yourdisconeedsyou/feed/", 1));
        add(new Section("I can hear music", "http://blogs.timeout.cat/icanhearmusic/feed/", 1));
        add(new Section("Brutus", "http://blogs.timeout.cat/brutus/feed/", 1));
        add(new Section("Olor de tinta", "http://blogs.timeout.cat/olor-de-tinta/feed/", 1));
        add(new Section("L'Escuradents", "http://blogs.timeout.cat/escuradents/feed/", 1));
        add(new Section("Literatura barata", "http://blogs.timeout.cat/literatura-barata/feed/", 1));
        add(new Section("Addictes al 8è art", "http://blogs.timeout.cat/addictes-al-8e-art/feed/", 1));
        add(new Section("Cuaderno de viaje", "http://blogs.elperiodico.com/viajes/feed/?_ga=1.183745446.1073564764.1445817152", 1));
