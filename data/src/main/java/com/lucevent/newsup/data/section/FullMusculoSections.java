...
public class FullMusculoSections extends Sections {
    ...
    public FullMusculoSections()
    {
        ...
        add(new Section("Abs", "http://fullmusculo.com/home/category/entrenamientos_y_ejercicios/abs/feed/", 1));
        ...
        add(new Section("Cuadriceps", "http://fullmusculo.com/home/category/entrenamientos_y_ejercicios/ejercicios/cuadriceps/feed/", 1));
        add(new Section("Espalda", "http://fullmusculo.com/home/category/entrenamientos_y_ejercicios/ejercicios/espalda/feed/", 1));
        add(new Section("Femorales", "http://fullmusculo.com/home/category/entrenamientos_y_ejercicios/ejercicios/femorales/feed/", 1));
        add(new Section("Entrenamiento", "http://fullmusculo.com/home/category/entrenamientos_y_ejercicios/entrenamiento/feed/", 1));
        add(new Section("Equipamiento", "http://fullmusculo.com/home/category/entrenamientos_y_ejercicios/equipamiento/feed/", 1));
        ...
        add(new Section("Motivaci\u00F3n", "http://fullmusculo.com/home/category/salud_y_vida/motivacion/feed/", 1));
